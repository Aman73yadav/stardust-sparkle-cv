      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-6">
          <div className="inline-block px-4 py-2 bg-primary/10 border border-primary/20 rounded-full">
            <span className="text-primary text-sm font-medium">Full Stack Developer & Data Scientist</span>
          </div>
          
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold">
            Hi, I'm <span className="text-primary text-glow">Your Name</span>
          </h1>
          
          <p className="text-lg text-muted-foreground max-w-xl">
            Building innovative solutions with AI, Full Stack Development, and Machine Learning. 
